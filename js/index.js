...
function getBudget (price) {
  ...
  .done(function (data) {
    data.forEach(function (datum) {
      ...
      $('#main').append('<div>Add To History :<button id="' + data.indexOf(datum) + 'Btn" class="btn-small saveOption"><span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span><p class="datumID hide">' + datum._id + '</p></button></div>')
    })
